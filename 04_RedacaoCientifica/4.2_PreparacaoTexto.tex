...
\begin{itemize}
    ...
    \vone
    \item Seja preciso. Os métodos são semelhantes às receitas dos livros de receitas. Se uma mistura de reação foi aquecida, forneça a temperatura. Perguntas como "como" e "quanto" devem ser respondida com precisão pelo autor e não deixada para o revisor ou o leitor decifrar.
\end{itemize}
...
\begin{itemize}
    ...
    \vone
    \item Como você apresenta os dados? Uma simples transferência de dados do "caderno de laboratório" para o texto dificilmente será suficiente. No testo você deve apresentar dados representativos em vez de dados repetitivos infinitos.
    \vone
